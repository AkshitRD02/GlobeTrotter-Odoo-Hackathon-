...
class GlobeTrotterApp {
  constructor() {
    ...
    // Admin State
    this.adminTab = 'users';
    this.usersDb = JSON.parse(localStorage.getItem('gt_users_db')) || USERS_DB;
  ...
  setupEventListeners() {
    ...
    document.getElementById('login-form').addEventListener('submit', (e) => {
      ...
      const isAdminEmail = email.toLowerCase() === 'admin' || email.toLowerCase() === 'admin@globetrotter.com' || email.toLowerCase() === 'admin@example.com';
      ...
      this.user = {
        ...
        language: 'en',
        currency: 'USD',
        savedDestinations: isAdminEmail ? [] : ['paris', 'london']
      };
      this.saveState();
      this.updateUserSessionUI();
      this.navigateTo('dashboard');
    ...
    document.getElementById('signup-form').addEventListener('submit', (e) => {
      ...
      const isAdminEmail = email.toLowerCase() === 'admin' || email.toLowerCase() === 'admin@globetrotter.com' || email.toLowerCase() === 'admin@example.com';
      if (isAdminEmail) {
        alert('This email identifier is reserved. Please sign in or use a different email.');
        return;
      }
    ...
    document.getElementById('profile-settings-form').addEventListener('submit', (e) => {
      ...
      this.user.email = document.getElementById('profile-email').value;
      this.user.language = document.getElementById('profile-language').value;
